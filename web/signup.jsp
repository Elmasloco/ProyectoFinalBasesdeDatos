                ...
                <fieldset class="formularioSignup__fieldset">
                    ...
                    <div class="contenedor-camposSignup">
                        ...
                        <div class="campo">
                            ...
                            <input class="campo__field" type="text" placeholder="calle algo #123" id="direccion" name="direccion">
                        </div> 
                        <div class="campo">
                            <label class="campo__label" for="telefono">Telefono</label>
                            <input class="campo__field" type="number" placeholder="123456" id="telefono" name="telefono">
                        </div> 
                        <div class="campo">
                    ...
                    <div class="flex alinear-centro">
                        <button class="boton enviar w-sm-100" name="accion" type="submit" value="agregarUser">Registrarme</button>
                    </div>
                </fieldset>
            </form>
        </section>
